...
type APIResponse struct {
	Logs       *oslog.Logs       `json:"query,omitempty" description:"query results"`
	Statistics *oslog.Statistics `json:"statistics,omitempty" description:"statistics results"`
	Histogram  *oslog.Histogram  `json:"histogram,omitempty" description:"histogram results"`
}
