...
func (s *Options) AddFlags(fs *pflag.FlagSet, c *Options) {
	fs.StringVar(&s.Host, "logging-opensearch-host", c.Host, ""+
	...
	fs.BoolVar(&s.BasicAuth, "logging-opensearch-basicAuth", c.BasicAuth, ""+
	...
	fs.StringVar(&s.Username, "logging-opensearch-username", c.Username, ""+
		"ElasticSearch authentication username, only needed when logging-elasticsearch-basicAuth is"+
		"set to true. ")

	fs.StringVar(&s.Password, "logging-opensearch-password", c.Password, ""+
	...
	fs.StringVar(&s.Version, "logging-opensearch-version", c.Version, ""+
